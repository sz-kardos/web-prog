...
<form action="" method="post" id="form1">
    ...
    <form action="" method="post" id="form2">
        ...
        <input type="date" class="mnb" name="date_interval_1" id="date_interval_1" value="2024-11-07" required>
        <input type="date" class="mnb" name="date_interval_2" id="date_interval_2" value="2024-11-17" required>
