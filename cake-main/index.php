                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                <h2>Ha valami igazán édesre vágysz, akkor a TortaKuckó a tökéletes hely számodra! </h2>
            ...
            <div class="row">
                <div class="col-lg-4 p-0">
                    <div class="instagram__text">
                        ...
                        <h5><i class="fa fa-instagram"></i> @tortakucko</h5>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li>Szombat: 10:00  – 16:30 </li>
                            <li>Vasárnap: 10:00  – 16:30 </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <p>"Torta, ami nemcsak finom, hanem történetekkel is megédesíti a napodat. Csatlakozz a TortaKuckóhoz!"</p>
